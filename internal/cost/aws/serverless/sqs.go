...
func (h *SQSHandler) Category() aws.CostCategory { return aws.CostCategoryUsageBased }

func (h *SQSHandler) ServiceCode() pricing.ServiceCode {
...
func (h *SQSHandler) CalculateCost(_ *pricing.Price, _ map[string]any) (hourly, monthly float64) {
