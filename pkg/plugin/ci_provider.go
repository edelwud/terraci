...
// PipelineGeneratorFactory creates pipeline generators bound to a pre-built IR.
// Core builds the IR once via pipeline.BuildProjectIR, then passes it here, so
