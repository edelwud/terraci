...
type SegmentNode struct {
	...
	Module    *costtypes.ModuleCost // non-nil only for leaf nodes (actual modules)
}

// BuildSegmentTree creates a tree from module paths split by "/".
func BuildSegmentTree(result *costtypes.EstimateResult, workDir string) *SegmentNode {
