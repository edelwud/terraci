...
func TestBuildSegmentTree(t *testing.T) {
	...
	t.Run("empty result", func(t *testing.T) {
		...
		tree := BuildSegmentTree(&costtypes.EstimateResult{}, workDir)
...
func TestCompactSegmentTree(t *testing.T) {
			...
			Children: []*SegmentNode{
				{Name: "a", Children: []*SegmentNode{
					{Name: "b", Children: []*SegmentNode{
						{Name: "c", Module: &costtypes.ModuleCost{AfterCost: 10}},
					}},
				}},
			},
		}
	...
	t.Run("stops at branch point", func(t *testing.T) {
		...
		root := &SegmentNode{
			Children: []*SegmentNode{
				{Name: "a", Children: []*SegmentNode{
					{Name: "b1", Module: &costtypes.ModuleCost{}},
					{Name: "b2", Module: &costtypes.ModuleCost{}},
				}},
			},
		}
	...
	t.Run("stops at module node", func(t *testing.T) {
		...
		root := &SegmentNode{
			Children: []*SegmentNode{
				{Name: "a", Module: &costtypes.ModuleCost{}, Children: []*SegmentNode{
					{Name: "b"},
				}},
			},
		}
