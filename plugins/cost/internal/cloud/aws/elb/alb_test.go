...
func TestALBHandler_Category(t *testing.T) {
	...
	contracttest.RunContractSuite(t, resourcespec.MustCompileTyped(ALBSpec(awskit.NewRuntimeDeps(awskit.NewRuntime(awskit.Manifest)))), contracttest.ContractSuite{
		Category: &category,
