...
func TestEIPHandler_Category(t *testing.T) {
	...
	definitiontest.RunContractSuite(t, resourcespec.MustCompileTyped(EIPSpec(awskit.NewRuntimeDeps(awskit.NewRuntime(awskit.Manifest)))), definitiontest.ContractSuite{
		Category: &category,
