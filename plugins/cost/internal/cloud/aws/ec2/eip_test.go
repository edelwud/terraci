...
func TestEIPHandler_Category(t *testing.T) {
	...
	contracttest.RunContractSuite(t, resourcespec.MustCompileTyped(EIPSpec(awskit.NewRuntimeDeps(awskit.NewRuntime(awskit.Manifest)))), contracttest.ContractSuite{
		Category: &category,
