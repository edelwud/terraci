...
func outputLog(result *tfupdateengine.UpdateResult) {
...
func logNoUpdatesSummary(summary tfupdateengine.UpdateSummary) {
	log.Info("summary")
	log.IncreasePadding()
...
func logSummary(summary tfupdateengine.UpdateSummary) {
	log.Info("summary")
	log.IncreasePadding()
