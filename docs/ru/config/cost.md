...
Показывать оценки стоимости в комментарии MR рядом с результатами plan и проверками политик.
...
При включённых `cost.enabled` и `cost.show_in_comment` оценки стоимости отображаются в таблице комментария MR. Для каждого модуля показывается разница месячной стоимости:
