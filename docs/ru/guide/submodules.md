---
title: "Сабмодули"
description: "Вложенные сабмодули: примеры использования, зависимости и лучшие практики"
outline: deep
---
...
- [Структура проекта](/ru/guide/project-structure) — паттерны директорий и обнаружение модулей
