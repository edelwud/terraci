...
description: "CLI-инструмент для анализа Terraform-проектов и генерации GitLab CI пайплайнов с учётом зависимостей"
outline: deep
---
...
| **Оценка стоимости** | Оценка стоимости AWS с разницей в MR-комментариях |
