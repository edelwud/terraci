...
Используя алгоритм Кана, TerraCi строит DAG зависимостей, где независимые
модули могут выполняться параллельно:
...
- Независимые модули могут выполняться параллельно
- Модули ждут джобы, которые производят нужные им данные
- Plan/apply представлены зависимостями джобов и артефактами
